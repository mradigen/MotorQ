...
async function testDatabaseSetup() {
    try {
        ...
        const vehicleWithTelemetry = await Vehicle.findByVinWithLatestTelemetry('TEST123456789');
        console.log('Vehicle with telemetry:', vehicleWithTelemetry?.latest_telemetry);
